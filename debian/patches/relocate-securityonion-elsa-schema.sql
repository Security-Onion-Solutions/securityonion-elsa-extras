Description: <short summary of the patch>
 ...
 it.
 .
 securityonion-elsa-extras (20131117-1ubuntu0securityonion73) precise; urgency=low
 .
   * relocate securityonion-elsa-schema.sql
...
@@ -104,7 +104,7 @@ function config_lognode() {
...
--- /dev/null
+++ securityonion-elsa-extras-20131117/contrib/securityonion-elsa-schema.sql
@@ -0,0 +1,689 @@
